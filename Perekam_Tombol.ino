...
//Mulai merekam dan memutar variabel, terkait mode
int recordPushed = 0;
int playPushed = 0;
...
int recordMod = 0;
int playMod = 0;
//Akhir Variabel Terkait dengan Mode Perekaman dan Pemutaran


//Simpan variabel mulai Relay 1
...
//Akhir variabel yang disimpan Relay 1

//Mulai variabel replikasi untuk eksekusi perekaman relay 1
...
//Akhir dari relay 2 disimpan variabel

//Mulai variabel replikasi untuk eksekusi perekaman relay 2
...
//Mulai variabel replikasi untuk eksekusi perekaman relay 3
...
//Relay 4 menyimpan variabel mulai
...
//Mulai variabel replikasi untuk menjalankan perekaman relay 4
...
void loop(void)
{
  ...
  if ((recordPushToNot == 1) && (recordNotToPush == 1)) {
    recordMod = 1;
    playMod = 0;
    Serial.println("Mode Record ON");
    digitalWrite(rEcordLED, HIGH);
    digitalWrite(pLayLED, LOW);


    //Inisialisasi variabel, Relay 1 merekam.
    pAuse00 = 0;
    pLay01 = 0;
    pAuse02 = 0;
    pLay03 = 0;
    ...
    //Inisialisasi variabel, Relay 2 merekam.
    re2pAuse00 = 0;
    re2pLay01 = 0;
    re2pAuse02 = 0;
    re2pLay03 = 0;
    ...
    //Inisialisasi variabel, Relay 3 merekam.
    re3pAuse00 = 0;
    re3pLay01 = 0;
    re3pAuse02 = 0;
    re3pLay03 = 0;
    ...
    //nisialisasi variabel, Relay 4 merekam.
    re4pAuse00 = 0;
    re4pLay01 = 0;
    re4pAuse02 = 0;
    re4pLay03 = 0;
  ...
  if ((playPushToNot == 1) && (playNotToPush == 1)) {
    if (playMod == 0) {
      playMod = 1;
      recordMod = 0;
      Serial.println("Mode Play ON");
      digitalWrite(pLayLED, HIGH);
      digitalWrite(rEcordLED, LOW);

      //Inisialisasi penetapan variabel perekaman ke variabel pemutaran relay 1
      pAuseC00 = pAuse00;
      pLayC01 = pLay01;
      pAuseC02 = pAuse02;
      pLayC03 = pLay03;
      ...
      //Inisialisasi penetapan variabel perekaman untuk menyampaikan 2 variabel pemutaran
      ...
      //Inisialisasi penetapan variabel perekaman untuk menyampaikan 3 variabel pemutaran
      ...
      //Inisialisasi penetapan variabel perekaman untuk menyampaikan 4 variabel pemutaran
  ...
  //Bagian operasi saat mode rekam Aktif
  if ((recordMod == 1) && (playMod == 0)) {
    ...
    if (iNput01 == HIGH) {
      ...
      //Mulai merekam saat tombol 1 ditekan
    ...
    //Saat tombol 1 mengambang
    else {
      digitalWrite(rElay01, LOW);
      delay(10);

      //Tombol 1 Floating Start Recording
      if (pLay01 == 0) {
        pAuse00 = pAuse00 + 1;
      }
      else if (pLay03 == 0) {
    ...
    if (iNput02 == HIGH) {
      ...
      //Mulai merekam saat tombol 2 ditekan
    ...
    //Saat tombol 2 mengambang
    else {
      digitalWrite(rElay02, LOW);
      delay(10);

      //Tombol 2 Mengambang Mulai Merekam
      if (re2pLay01 == 0) {
    ...
    if (iNput03 == HIGH) {
      ...
      //Mulai merekam saat tombol 3 ditekan
      ...
      //Akhir perekaman saat tombol 3 ditekan
    }
    //Saat tombol 3 mengambang
    else {
      digitalWrite(rElay03, LOW);
      delay(10);

      //Tombol 3 Perekaman Mulai Mengambang
      if (re3pLay01 == 0) {
    ...
    if (iNput04 == HIGH) {
      ...
      //Mulai merekam saat tombol 4 ditekan
    ...
    //Saat tombol 4 mengambang
    else {
      digitalWrite(rElay04, LOW);
      delay(10);

      //Tombol 4 Floating Start Recording
      if (re4pLay01 == 0) {
  ...
  //Kondisi saat memasuki mode putar
  if ((playMod == 1) && (recordMod == 0)) {
    //Relay 1 perekaman dan pemutaran kode terkait pemutaran mulai
    if (pAuseC00 != 00) {
      digitalWrite(rElay01, LOW);
      pAuseC00 = pAuseC00 - 1;
      delay(8);
    ...
    //Relay 2 perekaman dan pemutaran kode terkait mulai
    if (re2pAuseC00 != 00) {
      digitalWrite(rElay02, LOW);
    ...
    //Relay 3 perekaman dan pemutaran kode terkait mulai
    if (re3pAuseC00 != 00) {
      digitalWrite(rElay03, LOW);
    ...
    //Relay 4 perekaman dan pemutaran kode terkait mulai
    if (re4pAuseC00 != 00) {
      digitalWrite(rElay04, LOW);
    ...
    //Ketika semua variabel eksekusi perekaman relay 1 adalah 0, parameter eksekusi perekaman direset.
    ...
    //Ketika semua variabel eksekusi perekaman relay 1 menjadi 0, reset variabel eksekusi perekaman berakhir

    //Ketika semua parameter eksekusi perekaman relay 2 adalah 0, parameter eksekusi perekaman direset.
    ...
    //Ketika semua variabel eksekusi perekaman relay 2 adalah 0, reset variabel eksekusi perekaman selesai.

    //Ketika semua variabel eksekusi perekaman relay 3 adalah 0, parameter eksekusi perekaman direset.
    ...
    //Ketika semua variabel eksekusi perekaman relay 3 menjadi 0, reset variabel eksekusi perekaman selesai.

    //Ketika semua variabel eksekusi perekaman relay 4 adalah 0, parameter eksekusi perekaman direset.
    ...
    //Ketika semua variabel eksekusi perekaman relay 4 menjadi 0, reset variabel eksekusi perekaman selesai.
  }
}
